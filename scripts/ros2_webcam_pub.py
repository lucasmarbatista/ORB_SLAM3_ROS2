...
class ImagePublisher(Node):
    def __init__(self):
        ...
        self.rgb8pub = self.create_publisher(Image, "/camera/rgb", 10)
        self.bgr8pub = self.create_publisher(Image, "/camera/bgr", 10)
        self.mono8pub = self.create_publisher(Image, "/camera/mono", 10)
